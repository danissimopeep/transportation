    ...
    <div class="container">
        <div class="mt-3">
            <div class="row align-items-center justify-content-start">
                <div class="col-auto">
                    <a class="btn btn-secondary" href="/admin/orders">Активные</a>
                </div>
                <div class="col-auto">
                    <a class="btn btn-primary disabled" href="/admin/history">История</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="table table-striped table-hover table-sm">
                ...
                <#list orders as o>
                    <tr>
                        ...
                        <td class="col-1"><a class="btn btn-primary" href="/admin/history-order/${o.id}">Подробнее</a></td>
